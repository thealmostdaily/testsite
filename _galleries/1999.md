---
title: 1890
description: Fudge for finding by date.
layout: default
---
Need to loop so when new dates are added, pages and categories are generated. 
...
{% assign mid = site.works |  where: "work-year", "1890" | sort: "%Y" %}
